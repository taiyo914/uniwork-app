...
export default function DirectChat({ userId }: DirectChatProps) {
  ...
  return (
    <div className="h-full w-full">
      ...
      <div className="flex sm:hidden p-2 border-b bg-gray-50 flex items-center">
        <button onClick={() => router.push(`/employee/${locale}/chat`)} className="flex items-center space-x-1 text-blue-500">
