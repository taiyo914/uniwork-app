  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen} >
      <DialogTrigger asChild>
        <Button 
          className={`w-full h-16 lg:h-20 border border-gray-300 text-lg rounded-md shadow flex items-center justify-center bg-gray-200 text-gray-700 transition-all duration-300
